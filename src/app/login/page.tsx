                ...
                <main className="flex-1 flex flex-col items-center justify-center px-6 pb-12">
                    ...
                    <div className="glass-card w-full max-w-[400px] p-8 rounded-xl shadow-2xl">
                        ...
                        <button
                            ...
                            disabled={!!loadingMsg}
                            className="w-full flex items-center justify-center gap-3 bg-white/5 border border-white/10 hover:bg-white/10 text-white font-medium h-14 rounded-full transition-all active:scale-[0.98] disabled:opacity-50 mb-6"
                        >
                        ...
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <span className="text-[10px] text-slate-500 uppercase tracking-widest">o con email</span>
                            <div className="flex-1 h-px bg-white/10"></div>
                        </div>
